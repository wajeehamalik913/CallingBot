...
{
    using Common.Authentication.ApiKeyAuthentication;
    using Common.Authentication.BearerAuthentication;
    ...
    public static class AuthenticationServiceCollectionExtensions
    {
        ...
        // TODO This bad, split it off
        /// <summary>
        /// Registers Basic authentication service
        /// </summary>
        /// <param name="services"></param>
        /// <param name="configuration"></param>
        /// <param name="schemeName"></param>
        //public static void RegsiterBasicAuthenticationService(
        //    this IServiceCollection services,
        //    string schemeName,
        //    Type credentialRepositoryImplementation)
        //{
        //    if (credentialRepositoryImplementation.GetInterface(typeof(ICredentialRepository).FullName) == null)
        //    {
        //        throw new Exception("Invalid implementation for credential repository");
        //    }
        //    if (credentialRepositoryImplementation.GetInterface(typeof(ICredentialRepository).FullName) == null)
        //    {
        //        throw new Exception("Invalid implementation initializer");
        //    }

        //    services.AddTransient(typeof(ICredentialRepository), credentialRepositoryImplementation);

        //    // - Adding API key authentication scheme
        //    services.AddAuthentication()
        //        .AddBasicSupport(schemeName, options =>
        //        { });
        ...
        /// <param name="configuration"></param>
        /// <param name="schemeName"></param>
        public static void RegsiterBearerAuthenticationService(
            this IServiceCollection services,
            string schemeName,
            Type tokenServiceImplementation)
        {
            if (tokenServiceImplementation.GetInterface(typeof(ITokenService).FullName) == null)
            {
                throw new Exception("Invalid implementation for credential repository");
            }
            if (tokenServiceImplementation.GetInterface(typeof(ITokenService).FullName) == null)
            ...
            services.AddTransient(typeof(ITokenService), tokenServiceImplementation);

            // - Adding API key authentication scheme
            services.AddAuthentication()
                .AddBearerSupport(schemeName, options =>
                { });
